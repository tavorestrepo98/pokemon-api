...
var PokemonService = /** @class */ (function () {
    ...
    PokemonService.prototype.getPokemon = function (id1, id2) {
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            http_common_1.default.get("/pokemon/" + id1),
                            http_common_1.default.get("/pokemon/" + id2)
                        ])];
                    case 1:
                        resp = _a.sent();
    ...
    PokemonService.prototype.getTypes = function (names) {
        return __awaiter(this, void 0, void 0, function () {
            var peticionesHttp, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        peticionesHttp = names.map(function (name) {
                            return http_common_1.default.get("/type/" + name);
                        });
